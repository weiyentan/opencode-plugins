...
import { createGetJobEventsTool } from "./tools/job-events.js";
import { createListTemplatesTool, createListProjectsTool, createListJobsTool } from "./tools/list.js";
...
async function server(input: PluginInput): Promise<Hooks> {
  ...
  return {
    ...
    tool: {
      ...
      "awx-list-templates": createListTemplatesTool(getAwxClient, buildPipeTable),


      "awx-list-projects": createListProjectsTool(getAwxClient, buildPipeTable),


      "awx-list-jobs": createListJobsTool(getAwxClient, buildPipeTable),
      ...
      "awx-get-job-events": createGetJobEventsTool(getAwxClient),
